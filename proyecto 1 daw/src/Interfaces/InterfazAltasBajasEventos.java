...
public class InterfazAltasBajasEventos {
	 ...
	 */
	public void InterfazBuscarEvento(JFrame frame) {
		initialize();
		this.frame=frame;
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					try {
						...
						VentanaComprar window = new VentanaComprar(frmEventallBuscar, nombre);
		...
		btnNewButton_1.setIcon(new ImageIcon("C:\\Users\\Usuario\\Desktop\\WorkSpace_Rafa\\Proyecto\\src\\imgs\\atras2 (2).png"));
