...
public class Inicio {
	...
	private void initialize() {
		...
		/*
		 * ENCRIPTACION DE CONTRASEÃ‘A private String hash(String clear) throws
	...
	public boolean InicioSesion(String n_usuario, String contraseña) {
		...
		try {
			...
			ResultSet resultado = consulta
					.executeQuery("SELECT n_usuario, contraseÃ±a FROM usuario  WHERE  n_usuario = '"
							+ n_usuario
							+ "'  AND contraseÃ±a = '"
							+ contraseña
							+ "';");
			...
			while (resultado.next()) {
				...
				contraseña_ = resultado.getString("contraseÃ±a");
			}
